 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param revision 
 @return Orders*/
func (a *OrdersApiService) PostRevision(ctx context.Context, ordersNum string, memberId string, issuingAuthority string, revision Revision) (Orders,  *http.Response, error) {
	var (
